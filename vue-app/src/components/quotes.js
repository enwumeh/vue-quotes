const quotez = [
  ...
  {
    quote:
      "Welcome, everybody, to Monday Night Combat! We'd like to remind fans that we're committed to creating a safe, comfortable, enjoyable experience for only our Club-level and VIP guests. Everybody else...pay up for better seats next time!",
